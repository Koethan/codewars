...
// or return `-1` or ERROR or Nothing or None depending on the lang

function newAvg(arr, newavg) {

    let total = arr.reduce((a,b)=>a+b,0)
    let finalLength = (arr.length + 1)
    let estimatedTotal = newavg * finalLength
    let answer = estimatedTotal - total
    console.log(answer)
    if(answer < 1){
